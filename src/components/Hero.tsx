    ...
    <section className="flex flex-col items-center text-center py-16 space-y-8">
      <div className="space-y-4 max-w-3xl">
        <div className="flex justify-center">
          <span className="px-3 py-1 text-xs font-semibold tracking-wider text-purple-600 uppercase bg-purple-100 rounded-full">
        ...
        <div className="pt-4">
          <Link href={`/posts/${post.slug}`} className="inline-flex items-center px-6 py-3 text-base font-medium text-white bg-purple-600 rounded-md hover:bg-purple-700 transition-colors">
            Read Latest Post
