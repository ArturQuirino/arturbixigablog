...
image: '/covers/2026-03-27-lazy-loading-chunks.png'
---
...
![Entry point síncrono vs assíncrono: import estático entra no bundle principal; import() dinâmico faz o bundler criar um chunk separado](/images/diagram-import-estatico-vs-dinamico.svg)
...
![NgModule vs standalone: loadChildren e loadComponent com lazy loading geram chunk; import estático de módulo ou componente não gera chunk — o padrão é o mesmo](/images/diagram-ngmodule-vs-standalone-chunks.svg)
