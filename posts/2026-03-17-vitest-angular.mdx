...
{/* DIAGRAMA: Pirâmide de testes */}

> 📊 **[DIAGRAMA — Pirâmide de testes]** > _Inserir aqui o diagrama da pirâmide de testes com três camadas (Unitário / Componente / E2E), ferramentas posicionadas em cada camada, e os eixos de velocidade (↑ para baixo) e fidelidade (↑ para cima) nas laterais._
...
{/* DIAGRAMA: Tabela comparativa com heatmap visual */}

> 📊 **[DIAGRAMA — Comparação de ferramentas de teste]** > _Inserir aqui a tabela comparativa com células coloridas (verde/amarelo/vermelho) para Karma, Jest, Vitest, Cypress E2E e Cypress Component, nos eixos: ambiente de execução, suporte a ESM, integração com Vite/esbuild, watch mode inteligente, cold start, suporte oficial Angular CLI, e melhor caso de uso._
...
{/* DIAGRAMA: Fluxo do TestBed */}

> 📊 **[DIAGRAMA — Ciclo de setup do TestBed]** > _Inserir aqui um diagrama de fluxo linear mostrando as quatro etapas em sequência: (1) `configureTestingModule` — declara o módulo de teste; (2) `compileComponents` — compila templates; (3) `createComponent` — instancia o componente e cria o fixture; (4) `detectChanges` — dispara o primeiro ciclo de renderização e chama `ngOnInit`. Indicar entre as etapas 3 e 4 que o componente existe mas ainda não foi renderizado._
